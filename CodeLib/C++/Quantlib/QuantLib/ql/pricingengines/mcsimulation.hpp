...
namespace QuantLib {
    ...
    */
	...
	// aladdin: this class is to store MC params 
	// base MCparams class
	class MCParams{
		public:
			MCParams(Size timeSteps,Size timeStepsPerYear):  timeSteps_(timeSteps),timeStepsPerYear_(timeStepsPerYear)
			{
			...
			virtual Size getTimeSteps() const {return timeSteps_;};
			virtual Size getTimeStepsPerYear() const {return timeStepsPerYear_;};
	...
	public:
		MCVanillaParams(Size timeSteps,
			...
			Size maxSamples,
			BigNatural seed):MCParams(timeSteps,timeStepsPerYear),
			brownianBridge_(brownianBridge),antitheticVariate_(antitheticVariate),
		...
		Size getTimeSteps() const {return timeSteps_;};
		Size getTimeStepsPerYear() const {return timeStepsPerYear_;};
		bool getBrownianBridge() const {return brownianBridge_;};
		bool getAntitheticVariate() const {return antitheticVariate_;};
		Size getRequiredSamples() const {return requiredSamples_;};
		Real getRequiredTolerance() const {return requiredTolerance_;};
		Size getMaxSamples() const {return maxSamples_;};
		BigNatural getSeed() const {return seed_;};
	protected:
