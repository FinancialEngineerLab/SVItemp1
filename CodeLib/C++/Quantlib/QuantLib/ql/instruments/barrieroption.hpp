    ...
    */
	...
	//aladdin
      ...
      public:
        class arguments;
        class engine;
        BarrierKOKOOption(Barrier::Type barrierType,
                      Real barrierUp,
					  Real barrierDown,
                      const boost::shared_ptr<StrikedTypePayoff>& payoff,
                      const boost::shared_ptr<Exercise>& exercise);
    ...
    //! %Arguments for barrier option calculation
    class BarrierKOKOOption::arguments : public OneAssetOption::arguments {
      public:
        arguments();
        Barrier::Type barrierType;
        Real barrierUp;
    ...
    //! %Barrier-option %engine base class
    class BarrierKOKOOption::engine
        : public GenericEngine<BarrierKOKOOption::arguments,
                               BarrierKOKOOption::results> {
      protected:
        bool triggered(Real underlying) const;
    };
}
