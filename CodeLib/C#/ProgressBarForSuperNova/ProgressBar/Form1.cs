    ...
    public partial class Form1 : Form
    {
        ...
        void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            {// Your background task goes here
                ...
                string FileName = @"C:\\temp\Supernova.exe";    //打开的文件必须在该程序exe同目录下

                string fileToCopy = @"\\10.90.100.180\lhtz\SuperNova\Supernova.exe";
                string fileDesination = @"c:\\temp\Supernova.exe";
