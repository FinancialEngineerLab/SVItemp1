...
class Series(object):
    ...
    def setSecondayYAxisFlag(self, useSecYAxis):
        pass

    def getSecondayYAxisFlag(self):
        pass
    ...
    def plot(self, mplSubplot, dateTimes, color):
        ...
        # mplSubplot.set_ylim([0, max(values)*1.2])
...
class LineMarker(Series):
    ...
    def setSecondayYAxisFlag(self, useSecYAxis):
        self.__useSecYAxis = useSecYAxis

    def getSecondayYAxisFlag(self):
        return self.__useSecYAxis
...
class Subplot(object):
    ...
    def addDataSeries(self, label, dataSeries, defaultClass=LineMarker, useSecondayYAxisFlag=False):
        ...
        self.__callbacks[callback].setSecondayYAxisFlag(useSecondayYAxisFlag)
    ...
    def plot(self, mplSubplot, dateTimes):
        for series in self.__series.values():
            ...
            if series.getSecondayYAxisFlag():
                mplSubplotTwinx = mplSubplot.twinx()
                series.plot(mplSubplotTwinx, dateTimes, color)
                mplSubplot.plot(numpy.nan, color)
            else:
