...
if __name__ == "__main__":
    ...
    paras = [15, 20, 15, 15, 10, 2]   #  bollingerlength, numStdDev, closelength, ccMAlength, malength, space
    plot = True
    ...
    if plot:
        ...
        plt.getInstrumentSubplot(instrument).addDataSeries("upper", strat.getBollinger()[0])
        plt.getInstrumentSubplot(instrument).addDataSeries("lower", strat.getBollinger()[1])
