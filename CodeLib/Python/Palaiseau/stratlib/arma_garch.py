# -*- coding: utf-8 -*-
# ref: https://www.ricequant.com/community/topic/1319/
...
from pyalgotrade.technical import arma_garch
from pyalgotrade.tushare import data_from_tushare
from tools.performance_analyzer import performance_analyzer


class ARMAGARCH(strategy.BacktestingStrategy):
    def __init__(self, feed, instrument, period = 50, info_show=True):
        ...
        self.__armagarch = arma_garch.ARMAGARCH(dataSeries=self.__close, period=period)
